...
extern void irq_install_handler(int num,void (*func)(regs *r));
...
static void kbd_flush_buff()	//Clears the keyboard buffer (Hardware buffer)
{
	unsigned temp;
	do
	{
...
static void send_data(unsigned char data) //Sends a command or data to keyboard
{
