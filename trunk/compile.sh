...
ld -T link.ld loader.o vga.o string.o gdt.o mboot.o idt.o isr_wrap.o irq.o timer.o kbd.o phys_mem.o paging.o kmalloc.o gvga.o char.o windows.o label.o pci.o kernel.o -o kernel
echo "done"
